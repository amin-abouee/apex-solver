//! Integration test for RadTan camera with SelfCalibration
//!
...
//!
//! The radtan model is the simplest camera model with no distortion,
...
#[test]
fn test_radtan_self_calibration_50_points() {
    // ============================================================================
    // 1. Ground Truth Setup
    // ============================================================================

    // RadTan camera with typical parameters (VGA resolution, ~60° FOV)
    let true_camera = RadTanCamera::new(
        517.3, 516.5, 318.6, 255.3, // fx, fy, cx, cy
        0.2624, -0.9531, -0.0054, 0.0026, 1.1633, // k1, k2, p1, p2, k3
    );
    ...
    info!("\n========================================");
    info!("RadTan Self-Calibration Results:");
    info!("========================================");
    ...
    for i in 0..4 {
        ...
        // RadTan should recover intrinsics very accurately (no distortion, well-conditioned)
        assert!(
            param_error < 0.10,
