...
//! - **Double Sphere**: [`DoubleSphereProjectionFactor`]
//! - **EUCM**: [`EucmProjectionFactor`]
//! - **Kannala-Brandt**: [`KannalaBrandtProjectionFactor`]
//! - **Radial-Tangential**: [`RadTanProjectionFactor`]
//! - **UCM**: [`UcmProjectionFactor`]
//!
//! # Linearization
//!
