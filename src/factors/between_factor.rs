...
impl Factor for BetweenFactor<T> {
    ...
    fn linearize(
        ...
        let mut j_k1_k0_wrt_k1_inv = Matrix6::zeros();
        let mut j_k1_k0_wrt_k0 = Matrix6::zeros();
        ...
        let mut j_diff_wrt_k1_k0 = Matrix6::zeros();
        ...
        let jacobian = if compute_jacobian {
            ...
            let j_diff_wrt_k0 = j_diff_wrt_k1_k0 * j_k1_k0_wrt_k0;
